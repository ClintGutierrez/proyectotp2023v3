...
{
    protected $compras,$temporal_compra, $detalle_compra,$productos,$configuracion,$session;
    ...
    public function guarda()
    {
        ...
        $id_compra=$this->request->getPost('id_compra');
            $total= preg_replace('/[\S,]/','',$this->request->getPost('total')) ;
    ...
    function generaCompraPdf($id_compra){
        ...
        $pdf->Cell(195,5,'Entrada de Compra',0,1,'C');
        ...
        $pdf->Cell(195,5,'Total S/.'.number_format($datosCompra['total'],0,1,'R'),2,'.',',');
